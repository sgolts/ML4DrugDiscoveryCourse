...
The lab will cover the following concepts
  ...
  * RosettaScripts
  * Flex
  * [ddGMover](https://docs.rosettacommons.org/docs/latest/scripting_documentation/RosettaScripts/Movers/movers_pages/ddGMover)


### References

  Kyle A. Barlow, Shane Ó Conchúir, Samuel Thompson, Pooja Suresh,
  James E. Lucas, Markus Heinonen, Tanja Kortemme Flex ddG: Rosetta
  Ensemble-Based Estimation of Changes in Protein–Protein Binding
  Affinity upon Mutation J. Phys. Chem. B 2018, 122, 21, 5389–5399,
  https://doi.org/10.1021/acs.jpcb.7b11367
    * Flex ddG Protocol [tutorial](https://github.com/Kortemme-Lab/flex_ddG_tutorial)

## Lab Steps

### 1 Download and install Rosetta

   Download a [pre-compiled version](https://rosettacommons.org/software/download/) of Rosetta 
   Or download the source and compile it
   
      git clone https://github.com/RosettaCommons/rosetta
      cd rosetta/source
	  ./scons.py -j<NumOfJobs> mode=release bin

   On great lakes I would recommend doing this on a compute node
   requesting atleast `--cpus-per-task=10` and using `-j=10`

### 2 Gather MC4R DMS data from Howard2025
...
### 3 Predict ddG of mutations using pyrosetta
...
### 4 Plot and analyze the predicted and experimental ddG values
...
### 5 Briefly discuss strengths and limitations of the modeling strategy
